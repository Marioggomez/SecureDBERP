...
internal sealed class IamTestScope : IAsyncDisposable
{
    ...
    public async ValueTask DisposeAsync()
    {
        ...
        await Exec(connection, "DELETE FROM seguridad.contador_rate_limit WHERE id_tenant IS NULL AND endpoint IN ('AUTH.LOGIN','AUTH.MFA.CHALLENGE','AUTH.MFA.VERIFY','AUTH.VALIDATE_SESSION','WORKFLOW.APPROVAL_INSTANCE.CREATE','PURCHASE.REQUEST.SUBMIT','PURCHASE.REQUEST.APPROVE');");

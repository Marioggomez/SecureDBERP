...
BEGIN
    ...
    (
        ...
        (N'PURCHASE.ORDER.UPDATE', N'PURCHASE', N'ORDER', N'UPDATE', N'Permite actualizar cabecera/detalle mientras la orden esta en borrador.', N'Actualizar orden de compra en borrador.', 0, 1, 1),
        (N'PURCHASE.ORDER.SUBMIT', N'PURCHASE', N'ORDER', N'SUBMIT', N'Permite enviar orden de compra a flujo de aprobacion.', N'Enviar orden de compra.', 0, 1, 1),
        (N'PURCHASE.ORDER.APPROVE', N'PURCHASE', N'ORDER', N'APPROVE', N'Permite aprobar orden enviada. Requiere MFA y SoD.', N'Aprobar orden de compra.', 1, 1, 1)
...
(
    VALUES
    (N'PURCHASE.ORDER.READ', N'PURCHASE', N'READ', N'PURCHASE.ORDER.READ', N'Lectura de ordenes de compra.', 0, 1),
    (N'PURCHASE.ORDER.CREATE', N'PURCHASE', N'CREATE', N'PURCHASE.ORDER.CREATE', N'Creacion de ordenes de compra.', 1, 1),
    (N'PURCHASE.ORDER.UPDATE', N'PURCHASE', N'UPDATE', N'PURCHASE.ORDER.UPDATE', N'Actualizacion de ordenes de compra en borrador.', 1, 1),
    (N'PURCHASE.ORDER.SUBMIT', N'PURCHASE', N'SUBMIT', N'PURCHASE.ORDER.SUBMIT', N'Envio de orden de compra.', 1, 1),
    (N'PURCHASE.ORDER.APPROVE', N'PURCHASE', N'APPROVE', N'PURCHASE.ORDER.APPROVE', N'Aprobacion de orden de compra con MFA y SoD.', 1, 1)
...
BEGIN
    ...
    (
        ...
        (
            ...
            NULL,
            NULL,
            N'Entidad de orden de compra para autorizacion central y alcance de datos.',
            N'DIRECTO',
            NULL,
            CAST(1 AS BIT)
        )
...
BEGIN
    ...
    VALUES
    (N'PURCHASE.ORDER.CREATE', N'PURCHASE', N'PurchaseOrdersController', N'Create', N'POST', N'/api/v1/purchase/orders', N'Crear orden de compra en borrador.', N'PURCHASE.ORDER.CREATE', 1, 1, 1, 0, 0, 1, 0, N'PURCHASE.ORDER', 1),
    (N'PURCHASE.ORDER.READ.ONE', N'PURCHASE', N'PurchaseOrdersController', N'GetById', N'GET', N'/api/v1/purchase/orders/{id}', N'Obtener orden de compra por id.', N'PURCHASE.ORDER.READ', 1, 1, 1, 0, 0, 1, 0, N'PURCHASE.ORDER', 1),
    (N'PURCHASE.ORDER.READ.LIST', N'PURCHASE', N'PurchaseOrdersController', N'List', N'GET', N'/api/v1/purchase/orders', N'Listar solicitudes visibles por contexto.', N'PURCHASE.ORDER.READ', 1, 1, 1, 0, 0, 1, 0, N'PURCHASE.ORDER', 1),
    (N'PURCHASE.ORDER.UPDATE', N'PURCHASE', N'PurchaseOrdersController', N'UpdateDraft', N'PUT', N'/api/v1/purchase/orders/{id}', N'Actualizar solicitud en borrador.', N'PURCHASE.ORDER.UPDATE', 1, 1, 1, 0, 0, 1, 0, N'PURCHASE.ORDER', 1),
    (N'PURCHASE.ORDER.DETAIL.UPSERT', N'PURCHASE', N'PurchaseOrdersController', N'UpsertDetail', N'PUT', N'/api/v1/purchase/orders/{id}/details', N'Agregar o editar detalle en borrador.', N'PURCHASE.ORDER.UPDATE', 1, 1, 1, 0, 0, 1, 0, N'PURCHASE.ORDER', 1),
    (N'PURCHASE.ORDER.SUBMIT', N'PURCHASE', N'PurchaseOrdersController', N'Submit', N'POST', N'/api/v1/purchase/orders/{id}/submit', N'Enviar solicitud para aprobacion.', N'PURCHASE.ORDER.SUBMIT', 1, 1, 1, 0, 0, 1, 0, N'PURCHASE.ORDER', 1),
    (N'PURCHASE.ORDER.APPROVE', N'PURCHASE', N'PurchaseOrdersController', N'Approve', N'POST', N'/api/v1/purchase/orders/{id}/approve', N'Aprobar orden enviada (MFA obligatorio).', N'PURCHASE.ORDER.APPROVE', 1, 1, 1, 0, 1, 1, 0, N'PURCHASE.ORDER', 1);
...
(
    VALUES
    (N'PURCHASE.ORDER.SUBMIT', 60, 12, NULL, 0, 1),
    (N'PURCHASE.ORDER.APPROVE', 60, 8, NULL, 0, 1)
